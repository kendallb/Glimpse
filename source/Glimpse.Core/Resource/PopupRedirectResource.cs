...
namespace Glimpse.Core.Resource
{
    ...
    public class PopupRedirectResource : IPrivilegedResource, IKey
    {
        ...
        public IResourceResult Execute(IResourceContext context, IGlimpseConfiguration configuration)
        {
            ...
            if (request == null)
            {
                return new HtmlResourceResult(
                    "<html><body><h1>Sorry no requests are currently available</h1>This is a current limitation of this feature. For Glimpse client to work, Glimpse has to detect at least one requesting for which it is enabled.<br /><br />If you are using this feature and it is causing you issues, please let us know.</body></html>");
            }
